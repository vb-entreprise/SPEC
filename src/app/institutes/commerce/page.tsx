      ...
      <main className="flex-1">
        ...
        <section className="relative h-[42rem] overflow-hidden -mt-[120px]">
          <div className="absolute inset-0">
            <Image
              src="https://images.unsplash.com/photo-1560472354-b33ff0c44a43?w=1920&h=800&fit=crop"
              alt="Commerce and Finance"
              fill
          ...
          <div className="relative z-10 cu-container h-full flex flex-col items-center text-white text-center pt-[320px]">
            <div className="max-w-4xl mx-auto">
              <div className="w-24 h-24 bg-white rounded-full flex items-center justify-center mx-auto mb-6">
                <Image
                  src="/images/institutes/Commerce.png"
                  alt="Commerce Logo"
                  width={60}
                  height={60}
              ...
              <p className="text-lg md:text-xl text-indigo-100 mb-8 leading-relaxed max-w-3xl mx-auto">
                Excellence in Commerce and Financial Education
              </p>
              ...
              {programs.map((program, index) => (
                <div key={index} className="bg-white rounded-lg shadow-lg p-6 hover:shadow-xl transition-shadow duration-300">
                  <div className="text-center">
                    ...
                    <p className="text-indigo-600 font-semibold mb-3">{program.duration}</p>
